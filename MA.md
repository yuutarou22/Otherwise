...
こういう機能を追加して、あーしてこーして
自分の好きなように決めて進められる→楽ちん
だけど、行き詰まりやすい

自分では楽しい！新しいと思っていても既存だったりする。
斬新であれば斬新であるほど、トーク力が必要。きっかけ、優位性など。

【チームでものづくりすることの理由】
メンバーによって得意なことが異なる。
↓色んな人とチームを組んでみる！
↓色んな人と関わることで色んなアイデアが湧いてくる
...
他人に使ってもらうことで新たな発見もある
最初のうちはありきたりなものかもしれない

作ったものは積極的に自分が作ったものを公開していって欲しい
成長のためにフィードバックをもらう


出来ることが多いことはいいけど、限界はある
気の合う友人や、大人と仲間になって世界にひとつだけのプロジェクトを考えよう

まずは身近な人から便利だと思うところから

*リソース（時間）に余裕がある時は、一緒に○○勉強しないか、と時間を割いてでも相手に教える。
*そうすれば、チーム自体の効率もグンと上がるので結局おじゃん。


【長崎新聞写真デジタル部】
ドローンはヘリの回転数を変えて前進したりする
メディアにとってはカメラが搭載されているという事が一番の魅力
測量、建築現場の確認、PR動画、災害調査などに利用
ドローンで撮影した映像をARを利用して新聞の画像をとのリンク

SWITCHのゼル伝みたいなアングルで撮れる！
普通飛行機でしか撮れないアングルから手元で操縦して撮影することが可能になる！


数キロ離れたところから飛ばして火山口の調査、、、大体２キロメートル上空３００ｍまで行ける。
ただ、目に入るところまでにしましょね。

動画を見たところ広角レンズっぽいけど、レンズ自体は変えられない
...
子育て支援のこともできるといいな
ココの公園オススメだよーとか
登録する側ばかりではなく、それを見るだけのユーザのことも考えると発展性がある
既存のサービスを利用する。
アプリって沢山ありすぎてじゃまになってくる。
既存の他のアプリとの連携で離脱率低下を更に図る

マネタイズはどうする？
ローカルな情報を利用して提供などと言った形でやる？？？

～～～～～～～～～～～～～～～～～～～～～～～～～～～～～～～～～～～～～～＾
ローカルなお店のpoint機能は？
加入する→利点はカードの発行料がかからない→広告もランダムにしますよ→他に店側の利点は？
ローカルなお店のpoint機能が貯まると引換券などに繋がる


大きなお店はTポイントカードとかあるけどSpotに加盟してもらうといいのでは



５MB→インスコ→好きなモードを選んでもらって、追加でインストール
（ローカル情報ばかりしたい人、旅行客で何度も訪れない人、修学旅行＝小学生ならどこどこにボスのドラゴンが居るからとか、忍者を探せ－とか）

修学旅行→中高生はスマホ持ってるのが多い→口コミ拡散するとこういうメリットがあるよ～ってすると拡散されるのでは。
配布する時点ではマネタイズを考えない


リリースしてもまずどうユーザを掴むのか→長崎の人って意外と見ないよね。口コミばっかだよね、ネットサービス見ないよね。
